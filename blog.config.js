...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Sherraytt', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个还在为了能努力而努力的博士生', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.sherrraytt.top', // 网站地址
  ...
  GREETING_WORDS:
    ...
    'Hi，我是为了能努力而努力的博士生, Hi，今天也是进步的一天哦, 无限进步！',
